...
function selfcheck(){
  ...
  const Q={
    ...
    'q12-3':{t:'sel',ans:'b',why:'經典 CLT 假設樣本獨立同分布，且母體有有限平均與有限正變異數；樣本和（或樣本平均）扣除期望並除以標準差後，其分布趨近標準高斯。原分布不必是高斯，但不能省略這些條件。',fix:'誤選「樣本平均收斂到母體平均」的是大數法則，那是另一條定理。',ref:R12,refName:N12},
