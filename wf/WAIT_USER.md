...
- 以手機實際開啟[工程學習中央入口](https://justty32.github.io/engineer_study/)，確認 18 個課程入口可點擊；進入任一章節後再按「回到工程學習主站」，確認按鈕位置、觸控範圍與返回行為符合預期。目前內建瀏覽器控制介面因環境設定不完整而無法建立連線，靜態與 HTTP 導覽檢查已由 agent 完成。
- 以桌面 `1440×900` 與手機 `390×844` 實際開啟[機器人路徑與運動規劃](../專題/機器人路徑規劃/互動課程/index.html)、[機器人視覺](../專題/機器人視覺/互動課程/index.html)與[機器人學習與訓練](../專題/機器人學習/互動課程/index.html)，確認各 12 頁導覽、加深版字典搜尋、所有自由實驗、鍵盤焦點及瀏覽器主控台沒有錯誤、重疊或水平溢位。2026-08-15 已由 headless Chrome 驗證 6 個新增頁面的桌面／手機首屏與初始互動輸出；仍待真人操作所有控制值、鍵盤與實體觸控。
- 以桌面 `1440×900` 與手機 `390×844` 實際開啟[七軸機械手臂運動學互動課程](../專題/機器人運動學/互動課程/index.html)，確認 16 頁導覽、加深版字典搜尋、原有運動學互動，加上 SE(3) 扭量積分與校正敏感度互動、鍵盤焦點與瀏覽器主控台沒有錯誤、重疊或水平溢位。2026-08-15 已由 headless Chrome 驗證 2 個新增頁面的桌面／手機首屏與初始互動輸出；仍待真人操作所有控制值、鍵盤與實體觸控。
