# IoT 連線模組、協定與網路互動學習網站

← [知識群路線圖](../../知識群互動網站-路線圖.md)｜[連線模組整合](../../韌體-連線模組整合.md)｜[E5](../../../../電機/09-嵌入式特化/E5-IoT與邊緣運算.md)｜[計算機網路](../../../../電機/03-通訊特化/19-計算機網路.md)｜建置契約與驗收紀錄（已封存，見 `archive/`）
...
所有數值是教學預算，不替代模組 manual、電信商條件、封包擷取、網路量測或實機功耗剖面。
