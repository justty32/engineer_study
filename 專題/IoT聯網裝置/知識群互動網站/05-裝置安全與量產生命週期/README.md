...
← [知識群路線圖](../../知識群互動網站-路線圖.md)｜[E5 IoT](../../../../電機/09-嵌入式特化/E5-IoT與邊緣運算.md)｜[E3 韌體](../../../../電機/09-嵌入式特化/E3-嵌入式韌體與驅動.md)｜[韌體架構](../../韌體-架構與電源管理.md)｜[量產與認證](../../量產-測試與法規認證.md)｜建置契約與驗收紀錄（已封存，見 `archive/`）
